...
const Hero = () => {
  return (
    <section id="home" className="relative flex h-screen min-h-[580px] md:min-h-[660px] lg:min-h-[720px] items-center justify-start bg-black">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1400px] flex-col items-start justify-center px-4 pt-[clamp(4.5rem,8vh,6rem)] pb-[clamp(5.5rem,10vh,8rem)] sm:px-6 xl:px-10 -translate-y-[2vh] md:-translate-y-[3vh] lg:-translate-y-[4vh]">
        <div className="w-full max-w-[40rem] lg:max-w-[44rem]">
      ...
      <div className="absolute inset-x-0 bottom-[clamp(0.75rem,2.2vh,2.5rem)] z-20 flex justify-center px-4">
        <div className="w-[90%] md:w-[88%] lg:w-[85%] max-w-[1200px]">
          <StatsBar />
        </div>
      </div>
    </section>
