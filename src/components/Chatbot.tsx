...
const MAIN_CATEGORIES: MainCategory[] = [
  {
    ...
    intro: 'Kenmos Structural Engineering was established in January 2009 to deliver safe, innovative, and cost-effective structural designs across Ethiopia and East Africa. Led by founder Kenmos Tesfaye — over 20 years of expertise, 800+ projects delivered.',
    Icon: Building2,
    items: [
      { id: 'founder', title: 'Founder & Leadership', body: 'Kenmos Tesfaye, our Founder and General Manager, brings over 20 years of hands-on experience in structural design and steel structures across Ethiopia, personally leading the design and supervision of more than 800 successful projects ranging from 800K Birr to well over a billion Birr.', highlight: '20+ years · 800+ projects' },
      { id: 'philosophy', title: 'Our Design Philosophy', body: 'Cost and Value Optimization is our core pillar. We rigorously analyze every beam, slab, rebar layout and concrete grades to cut structural material cost by 10–15% without compromising safety — verified by advanced finite-element analysis.', highlight: '10–15% material savings' },
      { id: 'track', title: 'Proven Track Record', body: 'Since 2009 we have proudly served commercial banks, real estate developers, universities, stadiums, government institutions and private industrial clients throughout Ethiopia.', highlight: 'Delivering since 2009' },
    ],
  },
  {
    id: 'services',
    ...
    intro: 'Six integrated consultancy disciplines — structural design, supervision, project management, assessment, BOQ preparation and full engineering consultancy.',
    Icon: ShieldCheck,
    items: [
      { id: 'structural-design', title: 'Structural Design', body: 'Innovative, safe, and cost-effective structural designs for reinforced concrete and steel-frame buildings of any scale or complexity.', highlight: 'RC + Steel frames' },
      { id: 'supervision', title: 'Construction Supervision', body: 'End-to-end site supervision — steel fabrication inspections, concrete pour observations, reinforcement placement audits guarantee structural quality compliance at every stage.', highlight: 'Quality-first inspection' },
      { id: 'project-mgmt', title: 'Project Management', body: 'Turn-key project management keeping your build on-time and on-budget — from feasibility through design-team coordination, cost controls and milestone-driven closeout.', highlight: 'On time · On budget' },
      { id: 'assessment', title: 'Assessment & Retrofitting', body: 'Professional structural evaluation of existing buildings, seismic vulnerability assessments and certified retrofitting plans for aging or damaged structures.', highlight: 'Seismic + retrofits' },
      { id: 'tender-boq', title: 'Tender & BOQ Preparation', body: 'Accurate tender documentation and bills of quantities with precise material take-offs and competitive bid package pricing for your project.', highlight: 'Detailed BOQs' },
      { id: 'consultancy', title: 'Consultancy', body: 'Technical advisory, peer design reviews, constructability audits, structural due diligence and value-engineering alternative studies for developers and investors.', highlight: 'Expert advisory' },
    ],
    secondaryCta: { label: 'Get a Structural Review', action: 'openQuote' },
  },
  {
    id: 'projects',
    label: 'Projects',
    ...
    intro: 'A portfolio spanning luxury villas and apartment complexes through to heavy industrial warehouses, high-rise towers and landmark public buildings.',
    Icon: FolderKanban,
    items: [
      { id: 'commercial', title: 'Commercial Developments', body: 'High-rise office towers, mixed-use buildings, shopping malls, bank headquarters and retail centers throughout Addis Ababa.', highlight: 'High-rise · Mixed-use' },
      { id: 'industrial', title: 'Industrial & Steel Structures', body: 'Heavy-duty steel warehouses, factories, arch-truss factory sheds, university stadiums and specialized large-span industrial roofs.', highlight: 'Steel truss specialists' },
      { id: 'residential', title: 'Residential Complexes', body: 'Luxury villas, multi-family apartment blocks and mass housing developments delivered at every scale.', highlight: 'Villas · Apartments' },
      { id: 'institutional', title: 'Institutional & Public', body: 'Government buildings, university campuses, schools and public assembly spaces.', highlight: 'Government + Education' },
    ],
  ...
  },
  {
    ...
    title: 'Engineering Expertise Across Industries',
    intro: 'Deep, sector-specific structural know-how tailored to the unique demands of each industry.',
    Icon: Landmark,
    items: [
      { id: 'commercial-ind', title: 'Commercial Real Estate', body: 'Malls, offices, mixed-use and high-rise towers.' },
      { id: 'industrial-ind', title: 'Industrial & Manufacturing', body: 'Factories, warehouses and heavy industrial plants.' },
      { id: 'residential-ind', title: 'Residential Development', body: 'Luxury multi-unit apartment complexes.' },
      ...
      { id: 'infrastructure', title: 'Infrastructure & Specialized', body: 'Bridges, retaining walls and sporting venues.' },
    ],
  },
  {
    id: 'process',
    label: 'Our Process',
    kicker: 'How We Work',
    title: 'A Proven 4-Step Delivery Process',
    intro: 'A transparent, phase-gated workflow refined over 800+ successful project deliveries — designed to maximize value and minimize execution risk.',
    Icon: Workflow,
    items: [
      { id: 'p1', title: '1 · Discovery & Consultation', body: 'We meet owners and architects to define project requirements, budget, constraints and timeline goals.', highlight: 'Kick-off workshop' },
      { id: 'p2', title: '2 · Analysis & Design', body: 'State-of-the-art finite-element modelling (ASCE, ACI, Eurocodes) produces fully compliant structural systems.', highlight: 'FEM · ASCE · ACI' },
      { id: 'p3', title: '3 · Value Engineering', body: 'Optimize concrete mix designs, rebar schedules, steel grades and connection detailing for substantial bill savings.', highlight: '10–15% cost savings' },
      { id: 'p4', title: '4 · Construction Supervision', body: 'Rigorous pour and rebar placement inspections at every stage of construction.', highlight: 'Zero-compromise QA' },
    ],
  },
  {
    id: 'careers',
    ...
    intro: 'Join a growing team of structural engineers, CAD technicians and construction supervisors working on Ethiopia\u2019s most complex structural projects.',
    Icon: Users,
    items: [
      { id: 'culture', title: 'Why Work at Kenmos', body: 'Landmark project exposure, mentorship directly from senior engineers, clear professional growth tracks and a competitive compensation package that rewards excellence.', highlight: 'Mentorship · Growth' },
      { id: 'openings', title: 'How to Apply', body: 'We periodically hire structural engineers (senior & intermediate), CAD detailers and site engineers. Email your CV and portfolio to contact@kenmosengineering.com with the subject \u201cCareer Application \u2014 [Your Role].\u201d', highlight: 'CV + portfolio' },
    ],
  ...
  },
  {
    ...
    intro: 'Reach out for structural design reviews, new project inquiries or engineering consultations.',
    Icon: Phone,
    items: [
      { id: 'address', title: 'Office Address', body: brand.location },
      { id: 'phone-ch', title: 'Phone', body: brand.phone },
      { id: 'email', title: 'Email Address', body: brand.email },
      { id: 'hours', title: 'Business Hours', body: brand.hours },
    ],
    primaryCta: { label: 'Request a Free Consultation', action: 'openQuote' },
  },
  {
    id: 'quote',
    label: 'Get a Quote',
    kicker: 'Start Your Project',
    title: 'Request a Structural Review or Quote',
    intro: 'Tell us about your project. Our lead structural engineer will review your blueprints and propose value-engineered options within one business day.',
    Icon: FileText,
    items: [
      { id: 'prepare', title: 'What to Prepare', body: 'Architectural drawings, structural scope, site geotechnical report, project timeline, and any existing conditions survey when available.' },
      ...
      { id: 'consult-format', title: 'Consultation Format', body: 'In-person at our Piazza office, virtual call, or site walk \u2014 whichever works best for you.' },
    ],
